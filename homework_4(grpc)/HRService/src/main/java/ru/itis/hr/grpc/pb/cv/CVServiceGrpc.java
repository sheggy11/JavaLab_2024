...
public final class CVServiceGrpc {
  ...
  public static final io.grpc.MethodDescriptor<Cv.CVRequest,
      Cv.CVResponse> METHOD_GET_CV = getGetCVMethod();

  private static volatile io.grpc.MethodDescriptor<Cv.CVRequest,
      Cv.CVResponse> getGetCVMethod;

  @io.grpc.ExperimentalApi("https://github.com/grpc/grpc-java/issues/1901")
  public static io.grpc.MethodDescriptor<Cv.CVRequest,
      Cv.CVResponse> getGetCVMethod() {
    io.grpc.MethodDescriptor<Cv.CVRequest, Cv.CVResponse> getGetCVMethod;
      ...
      synchronized (CVServiceGrpc.class) {
        if ((getGetCVMethod = CVServiceGrpc.getGetCVMethod) == null) {
          CVServiceGrpc.getGetCVMethod = getGetCVMethod = 
              io.grpc.MethodDescriptor.<Cv.CVRequest, Cv.CVResponse>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(
                  "CVService", "GetCV"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  Cv.CVRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  Cv.CVResponse.getDefaultInstance()))
  ...
  public static abstract class CVServiceImplBase implements io.grpc.BindableService {
    ...
    /**
     */
    public void getCV(Cv.CVRequest request,
                      io.grpc.stub.StreamObserver<Cv.CVResponse> responseObserver) {
  ...
  public static final class CVServiceBlockingStub extends io.grpc.stub.AbstractStub<CVServiceBlockingStub> {
    ...
    /**
     */
    public Cv.CVResponse getCV(Cv.CVRequest request) {
  ...
  public static final class CVServiceFutureStub extends io.grpc.stub.AbstractStub<CVServiceFutureStub> {
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<Cv.CVResponse> getCV(
        Cv.CVRequest request) {
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_GET_CV:
          serviceImpl.getCV((Cv.CVRequest) request,
              (io.grpc.stub.StreamObserver<Cv.CVResponse>) responseObserver);
          break;
        default:
