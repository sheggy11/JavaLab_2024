...
public final class JobServiceGrpc {
  ...
  public static final io.grpc.MethodDescriptor<JobOuterClass.JobRequest,
      JobOuterClass.JobResponse> METHOD_GET_JOB = getGetJobMethod();

  private static volatile io.grpc.MethodDescriptor<JobOuterClass.JobRequest,
      JobOuterClass.JobResponse> getGetJobMethod;

  @io.grpc.ExperimentalApi("https://github.com/grpc/grpc-java/issues/1901")
  public static io.grpc.MethodDescriptor<JobOuterClass.JobRequest,
      JobOuterClass.JobResponse> getGetJobMethod() {
    io.grpc.MethodDescriptor<JobOuterClass.JobRequest, JobOuterClass.JobResponse> getGetJobMethod;
      ...
      synchronized (JobServiceGrpc.class) {
        if ((getGetJobMethod = JobServiceGrpc.getGetJobMethod) == null) {
          JobServiceGrpc.getGetJobMethod = getGetJobMethod = 
              io.grpc.MethodDescriptor.<JobOuterClass.JobRequest, JobOuterClass.JobResponse>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(
                  "JobService", "GetJob"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  JobOuterClass.JobRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  JobOuterClass.JobResponse.getDefaultInstance()))
  ...
  public static abstract class JobServiceImplBase implements io.grpc.BindableService {
    ...
    /**
     */
    public void getJob(JobOuterClass.JobRequest request,
                       io.grpc.stub.StreamObserver<JobOuterClass.JobResponse> responseObserver) {
    ...
    @java.lang.Override public final io.grpc.ServerServiceDefinition bindService() {
      return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
          .addMethod(
            ...
            asyncUnaryCall(
              new MethodHandlers<
                JobOuterClass.JobRequest,
                JobOuterClass.JobResponse>(
  ...
  public static final class JobServiceBlockingStub extends io.grpc.stub.AbstractStub<JobServiceBlockingStub> {
    ...
    /**
     */
    public JobOuterClass.JobResponse getJob(JobOuterClass.JobRequest request) {
  ...
  public static final class JobServiceFutureStub extends io.grpc.stub.AbstractStub<JobServiceFutureStub> {
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<JobOuterClass.JobResponse> getJob(
        JobOuterClass.JobRequest request) {
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_GET_JOB:
          serviceImpl.getJob((JobOuterClass.JobRequest) request,
              (io.grpc.stub.StreamObserver<JobOuterClass.JobResponse>) responseObserver);
          break;
        default:
  ...
  private static abstract class JobServiceBaseDescriptorSupplier
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return JobOuterClass.getDescriptor();
    }
